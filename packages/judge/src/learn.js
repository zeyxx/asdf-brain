...
let CONFIG = {
  // Paths - configurable via configure()
...
/**
 * Configure learning module paths and settings
 * @param {Object} config - { learningDir, ... }
 */
function configure(config = {}) {
  if (config.learningDir) {
    CONFIG.LEARNING_DIR = config.learningDir;
  }
  // Allow overriding other settings
...
// Note: Auto-initialize removed - caller should call initialize() explicitly
// This allows for proper configuration before loading
