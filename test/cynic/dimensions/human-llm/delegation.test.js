/**
 * Tests for lib/cynic/dimensions/human-llm/delegation.js
 */

import { describe, it, expect, beforeEach } from 'vitest';

const evaluatorModule = require('../../../../lib/cynic/dimensions/human-llm/delegation');
const EvaluatorClass = Object.values(evaluatorModule).find(v => typeof v === 'function');

describe('DELEGATION Dimension', () => {
  let evaluator;
  ...
  describe('Metadata', () => {
    it('should have correct name', () => {
      expect(evaluator.name).toBe('DELEGATION');
    });
  ...
  describe('evaluate()', () => {
    it('should return a valid result structure', async () => {
      ...
      expect(result.dimension).toBe('DELEGATION');
