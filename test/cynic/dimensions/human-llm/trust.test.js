/**
 * Tests for lib/cynic/dimensions/human-llm/trust.js
 */

import { describe, it, expect, beforeEach } from 'vitest';

const evaluatorModule = require('../../../../lib/cynic/dimensions/human-llm/trust');
...
describe('TRUST Dimension', () => {
  ...
  describe('Metadata', () => {
    it('should have correct name', () => {
      expect(evaluator.name).toBe('TRUST');
    });
  ...
  describe('evaluate()', () => {
    it('should return a valid result structure', async () => {
      ...
      expect(result.dimension).toBe('TRUST');
