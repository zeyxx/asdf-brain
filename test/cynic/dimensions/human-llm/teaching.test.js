/**
 * Tests for lib/cynic/dimensions/human-llm/teaching.js
 */

import { describe, it, expect, beforeEach } from 'vitest';

const evaluatorModule = require('../../../../lib/cynic/dimensions/human-llm/teaching');
const EvaluatorClass = Object.values(evaluatorModule).find(v => typeof v === 'function');

describe('TEACHING Dimension', () => {
  let evaluator;
  ...
  describe('Metadata', () => {
    it('should have correct name', () => {
      expect(evaluator.name).toBe('TEACHING');
    });
  ...
  describe('evaluate()', () => {
    it('should return a valid result structure', async () => {
      ...
      expect(result.dimension).toBe('TEACHING');
