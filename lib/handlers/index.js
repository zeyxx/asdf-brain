...
const nscoreHandlers = require('./nscore-handlers');
...
const HANDLERS = {
  ...
  brain_cynic_digest: cynicHandlers.handleCynicDigest,
  ...
  // N-Score Layer (K-Score for Knowledge)
  brain_nscore_calculate: nscoreHandlers.handleNScoreCalculate,
  brain_nscore_health: nscoreHandlers.handleNScoreHealth,
  brain_nscore_burn_candidates: nscoreHandlers.handleNScoreBurnCandidates,
  brain_nscore_transform_candidates: nscoreHandlers.handleNScoreTransformCandidates,
};
