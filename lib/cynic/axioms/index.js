...
// =============================================================================
// PHI CONSTANTS - Mathematical Foundation
// =============================================================================

const PHI = 1.618033988749895;
const PHI_SQ = PHI * PHI;                     // 2.618... (phi^2)
const PHI_INV = 1 / PHI;                      // 0.618... (phi^-1)
const PHI_INV_2 = PHI_INV * PHI_INV;          // 0.382... (phi^-2)
const PHI_INV_3 = PHI_INV_2 * PHI_INV;        // 0.236... (phi^-3)
...
const THRESHOLDS = {
  CRITICAL_LOW: Math.round(PHI_INV_3 * 100),   // 23.6 - Danger zone
  MINIMUM: Math.round(PHI_INV_2 * 100),        // 38.2 - Min doubt floor
  NEUTRAL: 50,                                  // 50.0 - Equilibrium
  GOOD: Math.round(PHI_INV * 100),             // 61.8 - Max confidence
  EXCELLENT: Math.round((1 - PHI_INV_3) * 100), // 76.4 - Very good
  EXCEPTIONAL: Math.round((PHI_INV + PHI_INV_3) * 100), // 85.4 - Exceptional (phi^-1 + phi^-3)
};

// =============================================================================
// THE 4 ASIMOV LAWS - Hierarchy of Constraints
// =============================================================================
...
const CONFIDENCE = {
  MAX: PHI_INV,           // 61.8% - never exceed
  MIN_DOUBT: PHI_INV_2,   // 38.2% - always maintain
  CEILING: PHI_INV * 100, // 61.8 as percentage
};
