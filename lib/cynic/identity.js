...
// =============================================================================
// PHI CONSTANTS - Import from canonical source
// =============================================================================
...
const {
  ...
  PHI_INV_2,
  PHI_INV_3,
  PHI_2: PHI_SQUARED,  // Alias for backward compatibility
  PHI_3: PHI_CUBED,    // Alias for backward compatibility
} = require('../../packages/core/src/axioms/constants');
