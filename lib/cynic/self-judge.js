...
const WORLDS = {
  ...
  BERIAH: {
    ...
    question: 'Est-ce vérifiable? Peut-on prouver?',
  ...
  ASSIAH: {
    ...
    question: 'Est-ce que ça converge vers la singularité?',
...
const DIMENSIONS = {
  ...
  PRIMARY: {
    ...
    COHERENCE: {
      world: 'ATZILUT',
      axiom: 'PHI',
      question: 'Est-ce cohérent avec l\'ensemble?',
      threshold: 70,
    },
    ...
    TRUTH: {
      world: 'BERIAH',
      axiom: 'VERIFY',
      question: 'Est-ce vérifiable et reproductible?',
      threshold: 70,
    },
    INTEGRITY: {
      world: 'BERIAH',
      axiom: 'VERIFY',
      question: 'Est-ce tamper-proof et signé?',
      threshold: 80,
    },
    ...
    ALIGNMENT: {
      world: 'ASSIAH',
      axiom: 'BURN',
      question: 'Les incentives sont-ils alignés?',
      threshold: 70,
    },
    PROGRESS: {
      world: 'ASSIAH',
      axiom: 'BURN',
      question: 'Avance-t-on vers la singularité?',
      threshold: 50,
    },
  },
  ...
  SECONDARY: {
    ...
    SECURE: {
      purpose: 'Protéger sans enfermer',
      antiPattern: 'Surveillance totale',
      threshold: 85,
    },
    PRIVATE: {
      purpose: 'Respecter sans cacher',
      antiPattern: 'Transparence forcée',
      threshold: 90, // Critical - cypherpunk value
    },
    SCALE: {
      purpose: 'Grandir sans dominer',
      antiPattern: 'Monopole',
      threshold: 50,
    },
    SIMPLIFY: {
      purpose: 'Clarifier sans réduire',
      antiPattern: 'Obscurantisme',
      threshold: 60,
    },
    ENABLE: {
      purpose: 'Autonomiser, pas automatiser',
      antiPattern: 'Remplacement humain',
