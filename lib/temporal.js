 ...
 *
 * NOTE: PHI constants are now imported from lib/cynic/axioms/constants.js
...
const {
  ...
  PHI_THRESHOLDS,
  TEMPORAL,
} = require('./cynic/axioms/constants');
...
// PHI_THRESHOLDS is now imported from ./cynic/axioms/constants.js
// Kept for backward compatibility - see import above
...
module.exports = {
    // φ constants (re-exported from ./cynic/axioms/constants.js)
    CONFIG,
    PHI,
    PHI_2,
    PHI_3,       // Added
    PHI_SQ,      // Added (alias for PHI_2)
    PHI_INV,
    PHI_INV_2,
    PHI_INV_3,
    PHI_INV_4,   // Added
    ...
    trackSeverity,
    getSeverityStats,
    // Temporal constants (from constants.js)
    TEMPORAL,
};
